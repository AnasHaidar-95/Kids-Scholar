  ...
  return (
    <div className="font-sans relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-1 pointer-events-none">
        <FloatingIcon Icon={FaCalculator} className="top-[57%] left-[5%]" />
        <FloatingIcon Icon={FaPlus} className="top-[30%] left-[40%]" />
        <FloatingIcon Icon={FaEquals} className="top-[67%] right-[10%]" />
        ...
        <FloatingIcon Icon={FaAtom} className="bottom-[8%] right-[20%]" />
        <FloatingIcon Icon={FaStar} className="top-[38%] right-[10%]" />
        <FloatingIcon Icon={FaSmile} className="bottom-[20%] right-[5%]" />
        <FloatingIcon Icon={FaRocket} className="top-[30%] left-[8%]" />
        <FloatingIcon Icon={FaPlay} className="bottom-[28%] left-[5%]" />
      </div>

      {/* Welcome Section */}
      <section className="relative z-10 bg-white px-6 sm:px-10 lg:px-20 text-center max-w-5xl mx-auto rounded-b-3xl flex flex-col justify-center items-center min-h-screen max-h-screen overflow-hidden py-10">
        ...
        <div className="flex justify-center items-center w-full h-[300px] sm:h-[400px] md:h-[500px] lg:h-[500px] mt-10">
      ...
      <section className="relative z-0 bg-[#dbeffe] py-20 px-6 lg:px-32 grid grid-cols-1 sm:grid-cols-2 gap-8 max-w-full rounded-t-3xl rounded-b-3xl shadow-lg min-h-[calc(100vh-80px)]">
        <div className="z-10 col-span-full grid grid-cols-1 sm:grid-cols-2 gap-8">
          {[
            {
              icon: FaCalculator,
              title: "Math Magic",
            ...
            return (
              <div
                key={i}
                className="relative bg-white rounded-2xl p-6 text-center hover:scale-105 transition transform duration-300 overflow-hidden cursor-pointer shadow-md"
                onClick={() => navigate(path)}
              >
                <Icon className="text-5xl text-[#f0c96a] mx-auto mb-4 z-10 relative" />
                <h2 className="text-2xl font-bold text-[#bb4fa9] mb-2 z-10 relative">
