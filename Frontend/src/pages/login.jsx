    ...
    >
      ...
      <div className="relative z-20 w-full max-w-md mx-4">
        ...
        {/* <img
          ...
          alt="fish"
          className="absolute -top-10 -left-13 w-45 h-24 z-10 animate-float"
        />
        <img
          src="/images/robot1.png"
          alt="robot"
          className="absolute -top-8 -right-15 w-50 z-10 animate-float"
        /> */}
        <img
          src="/images/oct.png"
          alt="octopus"
        ...
        <div className="bg-white bg-opacity-80 backdrop-blur-sm rounded-2xl shadow-xl p-8 border border-white border-opacity-50">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <Link className="text-[#8A2BE2] hover:underline" to={"/register"}>
              create Account
            </Link>
          </form>
        </div>
