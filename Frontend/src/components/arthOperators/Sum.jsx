 ...
 return (
   <div>
     ...
     <div className="flex flex-col min-h-screen bg-gradient-to-br from-[#fff3f9] to-[#dbeffe] font-sans">
       ...
       <div className="flex-grow flex flex-col items-center justify-start px-4 pt-28 relative">
         {/* Back & Title row */}
         <div className="flex items-center justify-between w-full max-w-xl mb-8 px-2">
           <button
             onClick={() => navigate(-1)}
             className="bg-[#bb4fa9] text-white font-bold px-5 py-2 rounded-full shadow-lg hover:bg-[#a13d93] transition text-sm sm:text-base"
           >
             ← Back
           </button>

           <h1 className="text-2xl sm:text-3xl font-extrabold text-[#bb4fa9] text-center flex-1 ml-[-2rem]">
             ➕ Addition Challenge
           </h1>
         </div>
