...
//   if (loading) return (
//     <p className="p-6 text-left bg-gray-100 min-h-screen">Loading stories...</p>
//   );
...
export default function UsersPage() {
  ...
  if (loading)
    return (
      <p className="p-6 text-left bg-gray-100 min-h-screen">
        Loading stories...
      </p>
    );
  if (error) return <p className="p-6 text-center text-red-600">{error}</p>;
      ...
      <main className="flex-1 p-6">
        ...
        {showModal && selectedStory && (
          <div className="fixed inset-0 flex items-center justify-center z-50">
            <div className="bg-white rounded-2xl shadow-2xl w-[90%] max-w-xl p-8 relative border border-gray-200">
              {/* Close button*/}
              <button
              ...
              {/* Modal title*/}
              <h2 className="text-2xl font-bold mb-4 text-[#bb4fa9] border-b pb-2">
                Story Details
              </h2>
